...
if __name__ == '__main__':
    ...
    numOfKeyFrames = len([f for f in os.listdir("/home/jitendra/Desktop/Mini-Project/KeyFrames/")
                          if os.path.isfile(os.path.join("/home/jitendra/Desktop/Mini-Project/KeyFrames/", f))])
    # print(numOfKeyFrames)
    counter = 0
    while counter < numOfKeyFrames:
        print("Processing for KeyFrame{0}".format(counter))
        # reading the input image
        imgg = cv2.imread("/home/jitendra/Desktop/Mini-Project/KeyFrames/frame{0}.jpg".format(counter), 0)
