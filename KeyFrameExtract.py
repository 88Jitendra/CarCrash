...
for name in glob.glob("/home/jitendra/Desktop/Mini-Project/FrameFolder*"):
    print(name)
    ...
    while i < numOfFrames-1:
        ...
        if float(l) > th:
            ...
            cv2.imwrite("/home/jitendra/Desktop/Mini-Project/KeyFrames/frame{0}.jpg".format(counter), img)
            counter += 1
        i = i + 1
