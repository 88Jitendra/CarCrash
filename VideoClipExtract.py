...
def make_shots(var):
    os.mkdir("VideoClips")
    subprocess.run(["scenedetect", "-i", var,        "-o", "/home/jitendra/Desktop/Mini-Project/VideoClips", "detect-content",
                    "-t", "27", "split-video"])
...
if __name__ == '__main__':
    ...
    for var in glob("/home/jitendra/Desktop/Mini-Project/RoadAccidents/RoadAccident*.mp4"):
    ...
    for var in glob("/home/jitendra/Desktop/Mini-Project/NonAccidents/videoplayback*.mp4"):
